            ...
            <div id="auth-left">
                ...
                <form action="" autocomplete="off">
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" class="form-control form-control-xl"value="" name="loginUsuario" placeholder="Usuario" autocomplete="off">
                        <div class="form-control-icon">
                            <i class="bi bi-person"></i>
                        </div>
                    </div>
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="password" class="form-control form-control-xl"value="" name="loginUsuario" placeholder="Password" autocomplete="off">
                        <div class="form-control-icon">
