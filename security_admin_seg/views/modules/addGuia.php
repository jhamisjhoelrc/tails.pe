                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-body">
                                <?php
                                    ...
                                    $subsidiary = ControllerSubsidiary::ctrShowSubsidiary('id', $sale['id_subsidiary']);
                                ?>
                                <div class="row pt-3">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="form-control input-lg" style="width: 100%;" name="type_voucher" id="type_voucher">
                                                <option value="<?php echo $sale['type_voucher']; ?>">
                                                <?php 
                                                    if($sale['type_voucher'] == '01'){
                                                         echo 'Factura';
                                                    } elseif ($sale['type_voucher'] == '03') { 
                                                        echo 'Boleta'; 
                                                    } else {
                                                        echo 'Otro'; 
                                                    }
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-lg" name="voucherAffected" id="voucherAffected" value="<?php echo $sale['serial_number'].'-'.$sale['correlative']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-lg" name="nameCustomer" id="nameCustomer" value="<?php echo $sale['customer'];  ?>">
                                            <input type="hidden" name="id_customer" id="id_customer" value="<?php echo $sale['id_customer']; ?>">
                                            <input type="hidden" name="serie_subsidiary" id="serie_subsidiary" value="<?php echo $subsidiary['serie']; ?>">
                                            <input type="hidden" name="id_subsidiary" id="id_subsidiary" value="<?php echo $subsidiary['id']; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row pt-3">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="form-control input-lg select2bs4" style="width: 100%;" name="districtPartida" id="districtPartida">
                                                <option value="<?php echo $subsidiary['id_district']; ?>"><?php echo $subsidiary['district']; ?></option>
                                                <?php 
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-lg" name="provincePartida" id="provincePartida" value="<?php echo $subsidiary['province']; ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-lg" name="departmentPartida" id="departmentPartida" value="<?php echo $subsidiary['department']; ?>" readonly>
                                        </div>
                                    </div>
